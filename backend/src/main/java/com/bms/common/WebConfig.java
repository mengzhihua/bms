...
import com.bms.system.audit.OpLogInterceptor;
import com.bms.system.auth.AuthInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    /** 允许跨域的前端来源，逗号分隔（bms.cors.origins / BMS_CORS_ORIGINS）；同源部署可留空 */
    @Value("${bms.cors.origins:http://localhost:5173}")
